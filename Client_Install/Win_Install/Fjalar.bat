...
curl -LJO https://github.com/Maninthebath/Hraefn/raw/main/Client_Install/Win_Install/Urd_batstart.vbs
curl -LJO https://github.com/Maninthebath/Hraefn/raw/main/Client_Install/Win_Install/Urdstart.bat
